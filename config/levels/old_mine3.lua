return {
    ...
    planes = {
        ...
        { distance = 40, tunnelShape = { direction = {0, 9} }, name = "side_wood1" },
        { distance = 40, tunnelShape = { direction = {0, -9} }, name = "side_wood2" },
        ...
        { name = "corner_hole", distance = 30, rotation = 0 },
