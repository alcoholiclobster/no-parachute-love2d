return {
    ...
    planes = {
        ...
        { name = "breakable1", distance = 50, rotation = 180 },
        { name = "breakable1", distance = 50, rotation = 270 },
        { name = "breakable1", distance = 20, rotation = 0 },
        { name = "breakable1", distance = 20, rotation = 90 },
        { name = "breakable1", distance = 20, rotation = 180 },
        { name = "side_wood1", distance = 50, rotation = 270 },
