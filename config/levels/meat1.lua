return {
    ...
    planes = {
        ...
        { distance = 10, name = "meat_long_middle_thing", rotation = 180 },
        { distance = 15, name = "meat_long_middle_thing" },
        { distance = 17, name = "meat_long_middle_thing" },
        { distance = 14, name = "meat_long_middle_thing", rotation = 180 },
        { distance = 1, name = "meat_long_middle_thing", rotation = 90 },
        { distance = 17, name = "meat_long_middle_thing", rotation = 180 },
        { distance = 15, name = "meat_long_middle_thing" },
        { distance = 17, name = "meat_long_middle_thing", rotation = 180 },
        { distance = 20, name = "meat_long_middle_thing" },
